...
namespace Encrypt
{
    public class PemKeyUtils
    {
        ...
        public RSACryptoServiceProvider GetRSAProviderFromPemFile(String pemfile)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public string getKeyContent(String pemfile)
        {
            bool isPrivateKeyFile = true;
            string pemstr = File.ReadAllText(pemfile).Trim();
        ...
        public byte[] DecodeOpenSSLPublicKey(String instr)
        {
            const String pempubheader = "-----BEGIN RSA PUBLIC KEY-----";
            const String pempubfooter = "-----END RSA PUBLIC KEY-----";
        ...
        public byte[] GetOpenSSL3deskey(byte[] salt, SecureString secpswd, int count, int miter)
        {
        ...
        public SecureString GetSecPswd(String prompt)
        {
        ...
        public void showBytes(String info, byte[] data)
        {
